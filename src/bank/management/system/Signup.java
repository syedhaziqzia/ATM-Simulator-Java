...
/*        ImageIcon i1 = new ImageIcon(getClass().getResource(" /icons/atm.jpg")); // Corrected path
        ...
        */
        ...
        r5.setFont(new Font("Segoe UI", Font.BOLD, 14));
        r5.setBackground(new Color(240, 248, 255));
        ...
        // dateChooser is positioned and added below with the other layout components
        ...
        getContentPane().setBackground(new Color(240, 248, 255)); // Alice Blue background for differentiation
