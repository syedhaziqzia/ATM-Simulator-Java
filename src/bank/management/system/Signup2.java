...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        */
        ...
        l12.setFont(new Font("Segoe UI", Font.BOLD, 13));
        
        l13 = new JLabel(formno);
        l13.setFont(new Font("Segoe UI", Font.BOLD, 13));
        
        b = new JButton("Next");
        b.setFont(new Font("Segoe UI", Font.BOLD, 14));
        b.setBackground(new Color(10, 25, 49));
        ...
        r3.setFont(new Font("Segoe UI", Font.BOLD, 14));
        r3.setBackground(new Color(240, 248, 255));
        
        r4 = new JRadioButton("No");
        r4.setFont(new Font("Segoe UI", Font.BOLD, 14));
        r4.setBackground(new Color(240, 248, 255));
        
        
        String religion[] = {"Muslim","Hinduism","Sikh","Christian","Other"};
        ...
        l5.setBounds(100, 270, 150, 20);
        add(l5);
        
        l11.setBounds(100, 290, 150, 20);
        add(l11);
        
        c4.setBounds(350, 270, 320, 45);
        add(c4);
